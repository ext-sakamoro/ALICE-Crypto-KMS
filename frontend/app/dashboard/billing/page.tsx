...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100 keys', 'ChaCha20-Poly1305 only', '1,000 operations/hr', 'Community support'] },
  { name: 'Pro', price: '$99/mo', features: ['10,000 keys', 'All algorithms (AES-256-GCM, XChaCha20)', 'Shamir secret sharing', 'Key rotation', '20,000 operations/hr', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited keys', 'HSM-backed storage', 'Custom algorithms', 'Audit logging', 'SLA 99.999%', 'Dedicated support'] },
];
